...
class FinancialTransaction(Base):
    ...
    interested_party: Mapped[str] = mapped_column(String(160), nullable=False, default="", index=True)
    ...
    entry_mode: Mapped[str] = mapped_column(String(20), nullable=False, default="avista", index=True)
    ...
    projection_label: Mapped[str] = mapped_column(String(120), nullable=False, default="")
    projection_start: Mapped[date | None] = mapped_column(Date, nullable=True)
